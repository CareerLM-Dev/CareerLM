...
def build_latex(profile: Dict) -> str:
    ...
    latex_parts: List[str] = [
        ...
        r"\titleformat{\section}{\vspace{-1pt}\scshape\raggedright\large}{}{0em}{}[\color{black}\titlerule \vspace{-2pt}]",
        r"\newcommand{\resumeItem}[1]{\item\small{#1 \vspace{-2pt}}}",
            r"\newcommand{\resumeSubheading}[4]{\vspace{-1pt}\item\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}\textbf{#1} & #2 \\\textit{\small#3} & \textit{\small #4} \\\end{tabular*}\vspace{-2pt}}",
            r"\newcommand{\resumeProjectHeading}[2]{\item\begin{tabular*}{0.97\textwidth}{l@{\extracolsep{\fill}}r}\small#1 & #2 \\\end{tabular*}\vspace{-2pt}}",
        ...
        r"\newcommand{\resumeItemListStart}{\begin{itemize}[topsep=0pt, partopsep=0pt, itemsep=0pt, parsep=0pt]}",
