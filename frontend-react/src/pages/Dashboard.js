...
function Dashboard() {
      ...
      if (history.length > 0) {
        ...
        const transformedData = {
          ...
          structure_suggestions:
            ...
            content.analysis?.structure_suggestions ||
            [],
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case "job_matcher":
        return (
          <JobMatcher resumeData={resumeData} setCurrentPage={setCurrentPage} />
        );
      case "resume_editor":
                    ...
                    <div className="flex flex-col items-center">
                      <div className="relative mb-3 md:mb-4">
                        <svg
                          ...
                          height="120"
                          viewBox="0 0 160 160"
                          className="transform -rotate-90 md:w-[140px] md:h-[140px]"
                        >
                          <circle
                            cx="80"
                            cy="80"
                        ...
                        <p className="font-semibold text-base">
                          {resumeData?.careerAnalysis?.analysis_summary
                            ...
                            resumeData?.careerAnalysis?.top_3_careers?.[0]
                              ?.career ||
                            formatRole(
                              userProfile?.questionnaire_answers
                                ?.target_role?.[0],
                            ) ||
                            "Not set"}
                        </p>
                        ...
                        <div className="bg-primary/5 border border-primary/20 rounded-lg p-3">
                          ...
                          <div className="space-y-1">
                            <div className="flex items-start justify-between py-2 border-t border-primary/10">
                              ...
                              <span
                                className="text-xs font-medium text-right ml-2 max-w-[200px] truncate"
                              ...
                              resumeData.careerAnalysis.top_3_careers[0].missing_skills
                                ...
                                .map((skill, idx) => {
                                  ...
                                  return (
                                    <span
                                      key={idx}
                                      className="inline-block px-2.5 py-1 bg-white text-destructive text-xs rounded-lg border border-destructive/30 font-medium"
                                    >
                                      {cleanSkill}
                                    </span>
                                  );
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full">
                            {resumeData?.careerAnalysis?.top_3_careers?.[0]
                              ...
                              resumeData?.alignment_suggestions?.length ||
                              0}{" "}
                            matched
                          </span>
                        </div>
                              ...
                              resumeData.careerAnalysis.top_3_careers[0].matched_skills
                                ...
                                .map((skill, idx) => {
                                  ...
                                  return (
                                    <span
                                      key={idx}
                                      className="inline-block px-2.5 py-1 bg-white text-primary text-xs rounded-lg border border-primary/30 font-medium"
                                    >
                                      {cleanSkill}
                                    </span>
                                  );
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:px-6">
        {backendDown && (
          <div className="bg-destructive/10 border border-destructive/30 text-destructive px-4 py-3 rounded-xl text-sm flex items-center gap-3 mb-4">
            ...
            <p>
              <strong>Unable to reach the server.</strong> Please ensure the
              backend is running.
            </p>
          </div>
        )}
